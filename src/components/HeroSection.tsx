        ...
        >
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              className="group flex items-center gap-2 rounded-lg bg-primary px-8 py-4 text-base font-semibold text-primary-foreground shadow-glow transition-all hover:opacity-90 cursor-pointer"
            >
            ...
            <a
              ...
              className="rounded-lg border border-border bg-secondary/50 px-8 py-4 text-base font-semibold text-foreground transition-colors hover:bg-secondary cursor-pointer"
            >
              Explore Services
            </a>
          </div>
